...
namespace homer6
{
    ...
    void Url::fromString(const std::string &source_string)
    {
        ...
        std::transform(
            ...
            this->scheme.begin(), [](string_view::value_type c)
    ...
    bool operator==(const Url &a, const Url &b)
    {
        ...
        return a.scheme == b.scheme && a.username == b.username && a.password == b.password && a.host == b.host && a.port == b.port && a.path == b.path && a.query == b.query && a.fragment == b.fragment;
    }
