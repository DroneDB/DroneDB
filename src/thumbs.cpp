...
fs::path generateThumb(const fs::path &imagePath, int thumbSize, const fs::path &outImagePath, bool forceRecreate){
    ...
    CPLSetConfigOption("GDAL_ALLOW_LARGE_LIBJPEG_MEM_ALLOC", "524288000"); // 512 MB, avoids ERROR 6: Reading this image would require libjpeg to allocate at least 107811081 bytes
