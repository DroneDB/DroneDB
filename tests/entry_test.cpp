...
namespace
{
    ...
    TEST(parseEntry, vo_EPSG31370)
    {
        ...
        */
        ...
        EXPECT_NEAR(e.polygon_geom.getPoint(0).x, 4.342762755994, 1e-9);
        EXPECT_NEAR(e.polygon_geom.getPoint(0).y, 50.69212694232, 1e-9);
        EXPECT_NEAR(e.polygon_geom.getPoint(1).x, 4.345168867205, 1e-9);
        EXPECT_NEAR(e.polygon_geom.getPoint(1).y, 50.69212743836, 1e-9);
        EXPECT_NEAR(e.polygon_geom.getPoint(2).x, 4.345169386691, 1e-9);
